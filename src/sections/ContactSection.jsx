...
function ContactSection() {
  ...
  return (
    <section id="contacto" className="section-shell pb-24 pt-24">
      <div className="rounded-[2.8rem] border border-white/70 bg-white/80 p-8 shadow-soft backdrop-blur-xl sm:p-10 lg:p-14">
        <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noreferrer" className="rounded-[2rem] border border-olive/10 bg-cream/50 p-6 transition hover:-translate-y-1 hover:bg-white hover:shadow-card">
            ...
            <div className="rounded-[2rem] border border-olive/10 bg-cream/50 p-6">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {coverageZones.map((zone) => (
                  <span key={zone} className="rounded-full border border-olive/10 bg-white px-3 py-2 text-sm text-forest">
                    {zone}
                  </span>
                ))}
              </div>
            ...
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="rounded-[2rem] border border-olive/10 bg-cream/50 p-6 transition hover:-translate-y-1 hover:bg-white hover:shadow-card sm:col-span-2">
